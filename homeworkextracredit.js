...
function detectCapsLock(event) {
    ...
    if (event.getModifierState("CapsLock")) {
        capsWarning.classList.add("show-warning"); //actually shows the warning
    } else {
        capsWarning.classList.remove("show-warning");// hides the warning
    }
}
...
//password visibility toggle thing is added here
let eyeicon = document.getElementById("eyeicon");
let password = document.getElementById("password");

let eyeiconConfirm = document.getElementById("eyeicon-confirm")
let confirmPasswordInput = document.getElementById("con_password");

//first password visibility toggle thing
...
// Second password visibility toggle
eyeiconConfirm.onclick = function() {
    if (confirmPasswordInput.type === "password") {
        confirmPasswordInput.type = "text";
        eyeiconConfirm.src = "visibility.png";
    } else {
        confirmPasswordInput.type = "password";
        eyeiconConfirm.src = "visibility_off.png";
    }
};
